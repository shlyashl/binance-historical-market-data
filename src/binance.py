...
class Benance:
    def __init__(self, ch_conn, symbols_to_skip=None, **kwargs):
        ...
        self._max_rps = asyncio.Semaphore(16)
    ...
    async def _get_candle_data(self, symbol: str, ts_start: str, ts_end: str):
        ...
        for candle in response_json:
            ...
            data.append(
                [symbol, time_open, time_close, opening_price_in_usd, highest_price_in_isd, the_lowest_price_in_usd,
        ...
        df = pd.DataFrame(
            data, columns=[
                'symbol', 'time_open', 'time_close', 'opening_price_in_usd', 'highest_price_in_isd',
